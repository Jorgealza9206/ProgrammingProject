...
# Author: Alex
# Description: C:\Users\Alex\Dropbox\DegreeProject\Papers 2\Carpio_LoopezDeCastro_Jorge_tfg.pdf PAGINA 22
...
class FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_keep_m_in_n_0 = blocks.keep_m_in_n(gr.sizeof_char, 1, 4, 0)
        self.blocks_float_to_uchar_0 = blocks.float_to_uchar()
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'D:\\My Drive\\ProgrammingProject\\MaquinaNativa1\\fsk_sink.bin', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.analog_pll_freqdet_cf_0 = analog.pll_freqdet_cf(2*math.pi*0.1, math.pi*0.1, -math.pi*0.1)
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(math.pi*0.1)
        ...
        self.connect((self.analog_pll_freqdet_cf_0, 0), (self.blocks_threshold_ff_0, 0))
        self.connect((self.blocks_char_to_float_0, 0), (self.blocks_repeat_0, 0))
        self.connect((self.blocks_float_to_uchar_0, 0), (self.blocks_keep_m_in_n_0, 0))
        self.connect((self.blocks_keep_m_in_n_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_keep_m_in_n_0, 0), (self.blocks_vector_sink_x_0, 0))
