...
class FM_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FM_1")
        ...
        self.gain = gain = 50
        self.freq_selection = freq_selection = 830e6
        ...
        self.Widget.addTab(self.Widget_widget_0, 'tab0')
        ...
        self.Widget.addTab(self.Widget_widget_1, 'tab1')
        ...
        self.Widget.addTab(self.Widget_widget_2, 'tab2')
        ...
        self.Widget.addTab(self.Widget_widget_3, 'tab3')
        ...
        self.top_grid_layout.addWidget(_wbfm_on_check_box, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.Widget_layout_2.addWidget(self._qtgui_time_sink_x_0_win)
        ...
        self.Widget_layout_3.addWidget(self._qtgui_freq_sink_x_1_win)
        ...
        self.Widget_layout_1.addWidget(self._qtgui_freq_sink_x_0_0_win)
        ...
        self.Widget_layout_0.addWidget(self._qtgui_freq_sink_x_0_win)
        self._freq_selection_range = Range(800e6, 1900e6, 10e6, 830e6, 200)
        self._freq_selection_win = RangeWidget(self._freq_selection_range, self.set_freq_selection, "Frecuencia de Transmision", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_selection_win)
    ...
    def get_freq_selection(self):
        return self.freq_selection

    def set_freq_selection(self, freq_selection):
...
def main(top_block_cls=FM_1, options=None):
