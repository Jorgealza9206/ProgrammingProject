...
class descifrador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "descifrador")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'G:\\My Drive\\ProgrammingProject\\MaquinaNativa1\\sample_2.bin', True, 0, 0)
...
def main(top_block_cls=descifrador, options=None):
