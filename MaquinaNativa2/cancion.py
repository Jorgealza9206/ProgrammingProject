...
class cancion(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "cancion")
        ...
        self.settings = Qt.QSettings("GNU Radio", "cancion")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\Julian\\Desktop\\ProgrammingProject\\MaquinaNativa2\\cancion.wav', True)
...
def main(top_block_cls=cancion, options=None):
