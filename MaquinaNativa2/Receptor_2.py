...
class Receptor_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Widget.addTab(self.Widget_widget_3, 'señal recibida')
        ...
        self.Widget_layout_2.addWidget(self._qtgui_freq_sink_x_0_win)
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.qtgui_freq_sink_x_0, 0))
    ...
    def set_samp_rate_3(self, samp_rate_3):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate_3)
        self.qtgui_time_sink_x_1.set_samp_rate(self.samp_rate_3)
