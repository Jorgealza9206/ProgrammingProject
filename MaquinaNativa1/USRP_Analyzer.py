...
# Title: USRP_Analyzer
# Description: https://wiki.gnuradio.org/index.php?title=Guided_Tutorial_Hardware_Considerations
...
class USRP_Analyzer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "USRP_Analyzer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP_Analyzer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "USRP_Analyzer")
        ...
        self._samp_rate_range = Range(192000, 100e6, 1e3, 3.84e6, 200)
...
def main(top_block_cls=USRP_Analyzer, options=None):
