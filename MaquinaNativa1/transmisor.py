...
class transmisor(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(('192.168.10.2', "serial=F2F236")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.uhd_usrp_sink_0.set_center_freq(FR_freq, 0)
    ...
    def set_FR_freq(self, FR_freq):
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.FR_freq, 0)
