...
class BPSK_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_1")
        ...
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(math.pi)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_phase_modulator_fc_0, 0), (self.blocks_complex_to_float_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_add_xx_0, 0), (self.analog_phase_modulator_fc_0, 0))
...
def main(top_block_cls=BPSK_1, options=None):
