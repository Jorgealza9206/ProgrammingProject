...
class USRP_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "USRP_3 ASK")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP_3 ASK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "USRP_3")
        ...
        self._selector_labels = ('txt', 'vector', )
        ...
        self.top_grid_layout.addWidget(self._selector_tool_bar, 1, 0, 1, 1)
        for r in range(1, 2):
...
def main(top_block_cls=USRP_3, options=None):
