...
class FSK_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FSK_2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FSK_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FSK_2")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'D:\\My Drive\\ProgrammingProject\\MaquinaNativa1\\fsk_sink_2.bin', False)
