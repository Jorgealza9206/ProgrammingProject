...
class USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/alex/Documents/ProgrammingProject/Melendi - Destino o Casualidad ft. Ha Ash VDownloader.wav', True, 0, 0)
