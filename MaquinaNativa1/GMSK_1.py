...
class GMSK_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GMSK_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GMSK_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GMSK_1")
        ...
        self.digital_gmsk_mod_0 = digital.gmsk_mod(
            ...
            log=False,
            do_unpack=True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('G:\\My Drive\\ProgrammingProject\\MaquinaNativa1\\Melendi - Destino o Casualidad ft. Ha Ash VDownloader.wav', True)
...
def main(top_block_cls=GMSK_1, options=None):
