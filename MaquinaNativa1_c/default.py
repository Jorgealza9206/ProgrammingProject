...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1,samp_rate,samp_rate/(2*decimation), tw), 2000, samp_rate)
    ...
    def set_tw(self, tw):
        self.tw = tw
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1,self.samp_rate,self.samp_rate/(2*self.decimation), self.tw))
